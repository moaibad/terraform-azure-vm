...
resource "azurerm_virtual_network" "iac_network" {
  name                = "myVnet"
...
resource "azurerm_subnet" "iac_subnet" {
  name                 = "mySubnet"
  resource_group_name  = azurerm_resource_group.rg.name
  virtual_network_name = azurerm_virtual_network.iac_network.name
...
resource "azurerm_network_security_group" "iac_nsg" {
...
resource "azurerm_network_interface_security_group_association" "example" {
  network_interface_id      = azurerm_network_interface.iac_nic.id
  network_security_group_id = azurerm_network_security_group.iac_nsg.id
}
